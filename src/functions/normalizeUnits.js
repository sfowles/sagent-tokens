import { units } from '../meta/units.js';

export const _normalizeUnits = (value, currentUnit, newUnit) => {
  ...
  if (value && currentUnit && newUnit) {
    ...
    if (rootSize !== undefined && unitSize !== undefined) {
      ...
      console.warn(
        'normalizeUnits(): rootSize and/or unitSize variables are either undefined or not valid px values.'
      );
      return;
    }
  } else {
